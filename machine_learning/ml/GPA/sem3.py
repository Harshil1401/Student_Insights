...
# Save the model
joblib.dump(model_data, "data/ml/Sem3_gpa_forecaster.pkl")
print("📦 Model saved as Sem3_gpa_forecaster.pkl")


# import joblib

# # Load model
# model = joblib.load("sem3_gpa_predictor.pkl")
