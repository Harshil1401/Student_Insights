...
required_columns = ['Sem1 GPA', 'Sem2 GPA', 'Sem3 GPA', 'Sem4 GPA', 'Sem5 GPA']
df = df[required_columns].dropna()  # drop rows with missing GPAs

# Features (Sem1 to Sem7), Target (Sem8)
X = df[['Sem1 GPA', 'Sem2 GPA', 'Sem3 GPA', 'Sem4 GPA']]
y = df['Sem5 GPA']
...
# Save the model
joblib.dump(model_data, "data/ml/Sem5_gpa_forecaster.pkl")
print("📦 Model saved as Sem5_gpa_forecaster.pkl")
