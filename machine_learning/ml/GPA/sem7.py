...
required_columns = ['Sem1 GPA', 'Sem2 GPA', 'Sem3 GPA', 'Sem4 GPA', 'Sem5 GPA', 'Sem6 GPA', 'Sem7 GPA']
df = df[required_columns].dropna()  # drop rows with missing GPAs

# Features (Sem1 to Sem7), Target (Sem8)
X = df[['Sem1 GPA', 'Sem2 GPA', 'Sem3 GPA', 'Sem4 GPA', 'Sem5 GPA', 'Sem6 GPA']]
y = df['Sem7 GPA']
...
# Save the model
joblib.dump(model_data, "data/ml/Sem7_gpa_forecaster.pkl")
print("📦 Model saved as Sem7_gpa_forecaster.pkl")
